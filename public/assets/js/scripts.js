      ...
      if (params.slidesPerView === 'auto') {
        ...
        if (params.roundLengths) {
          ...
          if (swiper.isHorizontal()) {
            slideSize = parseFloat(slideStyles.getPropertyValue('width')) + parseFloat(slideStyles.getPropertyValue('padding-left')) + parseFloat(slideStyles.getPropertyValue('padding-right')) + parseFloat(slideStyles.getPropertyValue('margin-left')) + parseFloat(slideStyles.getPropertyValue('margin-right'));
          } else {
            slideSize = parseFloat(slideStyles.getPropertyValue('height')) + parseFloat(slideStyles.getPropertyValue('padding-top')) + parseFloat(slideStyles.getPropertyValue('padding-bottom')) + parseFloat(slideStyles.getPropertyValue('margin-top')) + parseFloat(slideStyles.getPropertyValue('margin-bottom'));
          }
        }
        if (currentTransform) {
...
var _showNav = require("./modules/show-nav");

var _fixedNav = require("./modules/fixed-nav");
...
var fadeIn = exports.fadeIn = function fadeIn() {};
...
var fixedNav = exports.fixedNav = function fixedNav() {
  var mainHeader = document.querySelector('.main-header');

  var setSticky = function setSticky(scroll) {
    if (scroll > 1) {
...
var showNav = exports.showNav = function showNav() {
